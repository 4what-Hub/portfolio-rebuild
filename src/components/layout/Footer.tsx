      ...
      <Container className="py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            <Link
              href="/"
              className="inline-block font-heading text-2xl text-[var(--text-primary)] hover:text-[var(--accent-primary)] transition-colors"
            >
              iwan.crafford
            </Link>
            <p className="mt-4 text-[var(--text-secondary)] text-sm leading-relaxed">
              Simply Beautiful - Finding Beauty in the Ordinary.
              <br />
          ...
          {/* Projects */}
          <div>
            <h4 className="font-heading text-lg text-[var(--text-primary)] mb-4">
              Projects
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-[var(--text-secondary)]">
              ...
              <li className="pt-2">Blouberg, Western Cape</li>
            </ul>
          </div>
        </div>

        {/* Bottom Bar */}
        <div className="mt-12 pt-8 border-t border-[var(--border-primary)] flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-[var(--text-secondary)] text-sm">
            &copy; {currentYear} Iwan Crafford. All rights reserved.
          </p>
